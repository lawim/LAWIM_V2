...
class V2PaymentAdapter:
    def to_domain_request(self, v2_payload: dict[str, Any]) -> DomainRuntimeRequest:
        ...
        return DomainRuntimeRequest(
            ...
            parameters={
                "project_id": v2_payload.get("project_id", data.get("project_id", "")),
                "payment_id": v2_payload.get("payment_id", data.get("payment_id", "")),
                "intent_id": v2_payload.get("intent_id", data.get("intent_id", "")),
                **data,
            },
    ...
    def record_divergence(
        ...
        if v2_status != v3_status:
            logger.info(
                "payment divergence: v2_status=%s v3_status=%s v2_result=%s v3_result=%s",
                v2_status,
                v3_status,
                v2_result,
                v3_result,

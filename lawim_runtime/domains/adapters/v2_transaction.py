...
class V2TransactionAdapter:
    def to_domain_request(self, v2_payload: dict[str, Any]) -> DomainRuntimeRequest:
        ...
        return DomainRuntimeRequest(
            ...
            parameters={
                ...
                "transaction_id": v2_payload.get("transaction_id", data.get("transaction_id", "")),
                **data,
            },
    ...
    def record_divergence(
        ...
        if v2_status != v3_status:
            logger.info(
                "transaction divergence: v2_status=%s v3_status=%s v2_result=%s v3_result=%s",
                v2_status,
                v3_status,
                v2_result,
                v3_result,

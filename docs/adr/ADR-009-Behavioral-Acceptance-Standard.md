# Standard Acceptation Comportementale
...
## Decision
Un module metier exige preuves comportementales, integration, multicanal, live et version deployee.
...
Accepter build, HTTP 200 ou rapport comme preuve suffisante.

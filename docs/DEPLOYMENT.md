...
- `AI_ORCHESTRATOR_ENABLED`, `AI_PRIMARY_PROVIDER`, `AI_COMPLEX_PROVIDER`, `AI_FALLBACK_CHAIN`: AI routing controls
- `DEEPSEEK_API_KEY`, `DEEPSEEK_MODEL`, `DEEPSEEK_BASE_URL`, `OPENAI_API_KEY`, `OPENAI_MODEL`, `GEMINI_PRIMARY_API_KEY`, `GEMINI_PRIMARY_MODEL`, `GEMINI_SECONDARY_API_KEY`, `GEMINI_SECONDARY_MODEL`: AI provider credentials and models
- `COMMUNICATION_FALLBACK_ENABLED`, `WHATSAPP_FALLBACK_ENABLED`, `TELEGRAM_FALLBACK_ENABLED`, `FALLBACK_MESSAGE`: fallback behavior

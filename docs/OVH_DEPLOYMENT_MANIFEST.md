...
- le runtime de [`code/lawim_v2/`](../code/lawim_v2/), y compris `i18n.py`, mais sans `migration.py`;
...
- les images et scripts de deployment dans [`deployment/docker/`](../deployment/docker/), [`deployment/nginx/`](../deployment/nginx/), [`deployment/systemd/`](../deployment/systemd/), [`deployment/health/`](../deployment/health/), [`deployment/server/scripts/`](../deployment/server/scripts/), [`deployment/scripts/`](../deployment/scripts/) et [`deployment/backup/`](../deployment/backup/);

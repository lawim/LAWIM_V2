...
| 2026-07-09 | DEC-009 | Mission 08.3 identifier login, standard demo accounts and access screen repair confirmed | Product | Authentication / access page / demo accounts | Active | reports/program/MISSION-08-3-AUTH-ACCESS-DEMO-ACCOUNTS.md |
| 2026-07-09 | DEC-010 | Production bootstrap now migrates legacy PostgreSQL auth columns and syncs the five standard demo accounts at startup | Product | Auth bootstrap / legacy migration / demo sync | Active | reports/program/MISSION-08-3-AUTH-ACCESS-DEMO-ACCOUNTS.md |
| 2026-07-09 | DEC-011 | Production ignores LAWIM_ADMIN_PASSWORD so the standard demo credentials remain canonical | Product | Production auth override policy | Active | reports/program/MISSION-08-3-AUTH-ACCESS-DEMO-ACCOUNTS.md |
| 2026-07-09 | DEC-012 | Mission 08.4 access cockpit, progressive property workflow and conversational qualification confirmed | Product | Access / dashboard / property / AI conversation | Active | reports/program/MISSION-08-4-FINITION-UX-PAGE-ACCES-DASHBOARDS-MODELE-LAWIM.md |
| 2026-07-09 | DEC-013 | Mission 08.4 OVH rebuild validated the app container and rechecked all five standard demo accounts | Product | Production rebuild / auth validation | Active | reports/program/MISSION-08-4-FINITION-UX-PAGE-ACCES-DASHBOARDS-MODELE-LAWIM.md |

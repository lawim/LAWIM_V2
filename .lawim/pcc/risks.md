...
| R-015 | PostgreSQL schema drift or constraint mismatch against the canonical data model | High | Medium | Reuse the official database reference, keep constraints explicit and validate the schema contract before implementation | Database | Open |

...
SUGGESTION_RULES: dict[str, list[dict[str, Any]]] = {
    "buy": [
        ...
        {"trigger": "minimum_search_ready", "suggestion": "Lancer une recherche de biens", "action": "search_properties", "priority": "high"},
        {"trigger": "progression_complete", "suggestion": "Préparer une visite des biens retenus", "action": "plan_visit", "priority": "high"},
    ],
    "rent": [
        ...
        {"trigger": "minimum_search_ready", "suggestion": "Lancer la recherche de locations", "action": "search_properties", "priority": "high"},
    ...
    "sell": [
        ...
        {"trigger": "minimum_search_ready", "suggestion": "Préparer la mise en vente", "action": "prepare_documents", "priority": "high"},
    ...
    "invest": [
        ...
        {"trigger": "minimum_search_ready", "suggestion": "Lancer l'analyse de marché", "action": "market_analysis", "priority": "high"},
    ...
    "build": [
        ...
        {"trigger": "minimum_search_ready", "suggestion": "Lancer la recherche de terrain", "action": "search_land", "priority": "high"},
    ...
    "find_land": [
        ...
        {"trigger": "minimum_search_ready", "suggestion": "Lancer la recherche de terrains", "action": "search_land", "priority": "high"},
    ...
    "find_partner": [
        ...
        {"trigger": "minimum_search_ready", "suggestion": "Rechercher dans l'annuaire LAWIM", "action": "search_partners", "priority": "high"},
    ],
    "find_funding": [
        ...
        {"trigger": "minimum_search_ready", "suggestion": "Préparer votre dossier de financement", "action": "prepare_documents", "priority": "medium"},
...
def _known_triggers(entities: dict[str, Any], progression: dict[str, Any], memory: dict[str, Any]) -> set[str]:
    ...
    if progression.get("minimum_search_ready") or progression.get("search_ready"):
        triggers.add("minimum_search_ready")

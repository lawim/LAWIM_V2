...
DEFAULT_PERMISSIONS: tuple[tuple[str, str, str, str], ...] = (
    ...
    ("perm-financial-catalog-read", "Read Financial Catalog", "financial.catalog", "read"),
    ("perm-financial-catalog-manage", "Manage Financial Catalog", "financial.catalog", "write"),
    ("perm-financial-pricing-read", "Read Financial Pricing", "financial.pricing", "read"),
    ("perm-financial-pricing-manage", "Manage Financial Pricing", "financial.pricing", "write"),
    ("perm-financial-quote-create", "Create Financial Quote", "financial.quote", "write"),
    ("perm-financial-quote-issue", "Issue Financial Quote", "financial.quote", "execute"),
    ("perm-financial-invoice-read", "Read Financial Invoices", "financial.invoice", "read"),
    ("perm-financial-invoice-issue", "Issue Financial Invoice", "financial.invoice", "execute"),
    ("perm-financial-payment-initiate", "Initiate Financial Payment", "financial.payment", "execute"),
    ("perm-financial-payment-read", "Read Financial Payments", "financial.payment", "read"),
    ("perm-financial-refund-request", "Request Financial Refund", "financial.refund", "write"),
    ("perm-financial-refund-approve", "Approve Financial Refund", "financial.refund", "admin"),
    ("perm-financial-subscription-manage", "Manage Financial Subscriptions", "financial.subscription", "write"),
    ("perm-financial-commission-read", "Read Financial Commissions", "financial.commission", "read"),
    ("perm-financial-commission-validate", "Validate Financial Commissions", "financial.commission", "admin"),
    ("perm-financial-payout-manage", "Manage Financial Payouts", "financial.payout", "admin"),
    ("perm-financial-ledger-read", "Read Financial Ledger", "financial.ledger", "read"),
    ("perm-financial-reconciliation-manage", "Manage Financial Reconciliation", "financial.reconciliation", "admin"),
    ("perm-financial-audit-read", "Read Financial Audit", "financial.audit", "read"),
    ("perm-financial-provider-manage", "Manage Financial Providers", "financial.provider", "admin"),
)

...
GOAL_PARTNER_MAP: dict[str, tuple[str, ...]] = {
    "buy": ("real_estate_agency", "notary", "bank", "property_expert"),
    "rent": ("real_estate_agency", "rental_manager", "insurer"),
    "sell": ("real_estate_agency", "notary", "property_expert"),
    "build": ("architect", "construction_company", "surveyor", "bank"),
    ...
    "other": ("real_estate_agency", "property_expert"),
}

...
DEFAULT_KPI_DEFINITIONS: tuple[tuple[str, str, str, str], ...] = (
    ...
    ("kpi-maintenance-messages", "Maintenance Messages", "maintenance", "maintenance"),
...
DEFAULT_DATA_MARTS: tuple[tuple[str, str, str], ...] = (
    ...
    ("mart-maintenance", "Maintenance Analytics", "maintenance"),
...
DEFAULT_SCORE_DEFINITIONS: tuple[tuple[str, str, str, str], ...] = (
    ...
    ("score-ai-confidence", "AI Confidence Score", "ai_confidence", "ai"),

...
DEFAULT_TEMPLATES: tuple[tuple[str, str, str, str, str], ...] = (
    ...
    (
        "tpl-welcome-email-en",
        "email",
        "Welcome to LAWIM",
        "Welcome to LAWIM",
        "Hello {{name}}, welcome to the LAWIM platform.",
    ),
    (
        "tpl-welcome-email-pcm",
        "email",
        "Welcome to LAWIM",
        "Welcome to LAWIM",
        "Hello {{name}}, welcome to LAWIM platform.",
    ),
    (
        "tpl-welcome-sms",
        "sms",
    ...
    (
        "tpl-welcome-whatsapp-en",
        "whatsapp",
        "WhatsApp Welcome",
        "",
        "Hello {{name}}, LAWIM welcomes you.",
    ),
    (
        "tpl-welcome-whatsapp-pcm",
        "whatsapp",
        "WhatsApp Welcome",
        "",
        "Hello {{name}}, LAWIM welcome you.",
    ),
    (

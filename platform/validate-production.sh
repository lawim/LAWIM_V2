...
export GREEN_API_PHONE="${GREEN_API_PHONE:-237686822667}"
export LAWIM_WHATSAPP_NUMBER="${LAWIM_WHATSAPP_NUMBER:-237686822667}"
export WHATSAPP_PUBLIC_NUMBER="${WHATSAPP_PUBLIC_NUMBER:-237686822667}"
export TELEGRAM_BOT_TOKEN="${TELEGRAM_BOT_TOKEN:-telegram-bot-token-placeholder}"
export TELEGRAM_BOT_USERNAME="${TELEGRAM_BOT_USERNAME:-lawim_bot}"
...
export AI_FALLBACK_CHAIN="${AI_FALLBACK_CHAIN:-deepseek,openai,gemini_primary,gemini_secondary}"
...
check "GREEN_API_PHONE is official" test "${GREEN_API_PHONE}" = "237686822667"
check "LAWIM_WHATSAPP_NUMBER is official" test "${LAWIM_WHATSAPP_NUMBER}" = "237686822667"
check "WHATSAPP_PUBLIC_NUMBER is official" test "${WHATSAPP_PUBLIC_NUMBER}" = "237686822667"
check "TELEGRAM_BOT_USERNAME is official" test "${TELEGRAM_BOT_USERNAME}" = "lawim_bot"

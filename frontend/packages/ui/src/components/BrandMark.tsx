...
export function BrandMark({ tone = 'dark', slogan = 'LAWIM · accompagnement immobilier intelligent', className = '', ...props }: BrandMarkProps) {
  ...
  return (
    <div className={`flex items-center gap-3 ${className}`.trim()} {...props}>
      <div className={`flex h-11 w-11 items-center justify-center overflow-hidden rounded-2xl ${isLight ? 'bg-white shadow-[0_16px_35px_rgba(15,23,42,0.12)]' : 'bg-slate-950/60 shadow-[0_16px_35px_rgba(37,99,235,0.28)]'}`}>

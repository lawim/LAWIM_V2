...
const TRANSLATIONS = {
  fr: {
    ...
    'auth.login.subtitle': 'Entrez votre email et votre mot de passe pour ouvrir votre cockpit.',
    ...
    'auth.login.banner.note': 'LAWIM ne demande jamais de rôle sur cette page. Le rôle provient de la réponse API.',
  ...
  en: {
    ...
    'auth.login.subtitle': 'Use your email and password to open your cockpit.',
    'auth.login.email': 'Email',
    ...
    'auth.login.banner.note': 'LAWIM never asks for a role on this page. The role comes from the API response.',
    'auth.logout': 'Logout',
  ...
  pcm: {
    ...
    'nav.dashboard': 'Dashboard',
    'nav.profile': 'Profile',
    'auth.login.title': 'Safe login',
    'auth.login.subtitle': 'Put your email and password make you open your cockpit.',
    'auth.login.email': 'Email',
    'auth.login.password': 'Password',
    'auth.login.button': 'Login',
    ...
    'auth.login.banner.note': 'LAWIM no dey ask role for this page. Role dey come from API answer.',
    'auth.logout': 'Comot',

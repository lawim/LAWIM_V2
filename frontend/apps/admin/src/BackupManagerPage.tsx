...
export function BackupManagerPage() {
  ...
  return (
    <PageShell
      ...
      description="Global storage, alerts, last test, and backup status at a glance."
    >
      <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
        ...
        <Card title="Remaining capacity" description="Available storage in the mock registry.">
        ...
        <Card title="Last test" description="Most recent mock validation timestamp.">
          <div className="mt-4 text-sm font-semibold text-white">{snapshot.lastTest}</div>
        </Card>
      </div>

      <div className="grid gap-6 xl:grid-cols-[0.85fr_1.15fr]">
        <Card title="Backup status" description="Backup orchestration is mock-ready and aligned with the registry.">
